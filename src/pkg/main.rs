...
fn main() -> ExitCode {
    ...
    match command {
        ...
        Commands::Interpret(args) => cmd_rez_stub("rez interpret", args.args),
        ...
        Commands::Release(args) => cmd_rez_stub("rez release", args.args),
        Commands::Selftest(args) => cmd_rez_stub("rez selftest", args.args),
        Commands::Test(args) => cmd_rez_stub("rez test", args.args),
        Commands::Yaml2py(args) => cmd_rez_stub("rez yaml2py", args.args),
        Commands::Bundle(args) => cmd_rez_stub("rez bundle", args.args),
        Commands::Benchmark(args) => cmd_rez_stub("rez benchmark", args.args),
